    ...
    <section className='works' id='works'>
      <div className='container mx-auto p-6'>
        ...
        <div className='flex justify-between align-center'>
          <div className='bg-secondary max-w-md rounded overflow-hidden shadow-lg flex-1 mr-3'>
            <img
              className='w-full'
          ...
          <div className='bg-secondary max-w-md rounded overflow-hidden shadow-lg flex-1 ml-3'>
            <img
              className='w-full'
